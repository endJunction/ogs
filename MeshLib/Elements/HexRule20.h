...
public:
    ...
    static constexpr unsigned n_all_nodes = 20u;

    /// Constant: The FEM type of the element
    static constexpr CellType cell_type = CellType::HEX20;

    /// Constant: Local node index table for faces
    static constexpr unsigned face_nodes[6][8] = {
    ...
    static constexpr unsigned edge_nodes[12][3] = {
        {0, 1, 8},   // Edge 0
        {1, 2, 9},   // Edge 1
        {2, 3, 10},  // Edge 2
        {0, 3, 11},  // Edge 3
