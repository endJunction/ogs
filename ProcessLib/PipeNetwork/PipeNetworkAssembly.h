...
namespace ProcessLib
{
    ...
    {
        const unsigned NUM_NODAL_DOF = 2; // TODO double check please!!!

        class PipeNetworkAssemblerInterface
        ...
        template <typename ShapeFunction, typename IntegrationMethod,
            unsigned GlobalDim>
            class LocalAssemblerData : public PipeNetworkAssemblerInterface
        {
        ...
        public:
            ...
            LocalAssemblerData(MeshLib::Element const& element,
                ...
                PipeNetworkProcessData const& process_data)
                : _element(element),
        ...
        private:
            ...
            PipeNetworkProcessData const& _process_data;
