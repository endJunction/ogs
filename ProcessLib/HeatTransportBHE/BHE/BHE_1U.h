...
public:
    ...
    BHE_1U(
        ...
        double my_threshold = 0.1) /* Threshold Q value for switching off the
                                   ...
                                   : BHEAbstract(BHE_TYPE::TYPE_1U, name,
                                                 borehole_geometry,
                                                 pipe_geometry,
    ...
    void update_flowrate_from_curve(double current_time)
    {
        if (use_flowrate_curve)
        {
            ...
            // double Q_r_tmp = GetCurveValue(flowrate_curve_idx, 0,
