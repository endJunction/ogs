			...
			public:
				...
				*/
				BHE_CXA(const std::string name             /* name of the BHE */,
					...
					: BHEAbstract(BHE_TYPE::TYPE_CXA, name, borehole_geometry, pipe_geometry, refrigerant_param, grout_param,
						extern_Ra_Rb, extern_def_thermal_resistances, std::move(bhe_curves), bound_type, if_flowrate_curve)
				{
					...
					CSA_i = PI * (pipe_geometry.r_outer * pipe_geometry.r_outer - (pipe_geometry.r_inner + pipe_geometry.b_in) * (pipe_geometry.r_inner + pipe_geometry.b_in));
