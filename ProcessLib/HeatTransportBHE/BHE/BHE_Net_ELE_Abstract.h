...
public:
     ...
     * constructor
     */
    BHE_Net_ELE_Abstract(std::string name, BHE_NET_ELE::type type,
                         int n_inlet = 1, int n_outlet = 1)
     ...
     */
    BHE_NET_ELE::type get_net_ele_type() { return _ele_type; }

    std::string get_ele_name() { return _name; }

    /**
     * get inlet temperature
     */
    double get_T_in(int idx = 0) { return T_in[idx]; }
     ...
     */
    double get_T_out(int idx = 0) { return T_out[idx]; }
     ...
     */
    void set_T_in(double val, int idx = 0) { T_in[idx] = val; }

    /**
     * set outlet temperature
     */
    void set_T_out(double val, int idx = 0) { T_out[idx] = val; }

    /**
     * return the number of inlet temperatures
     */
    int get_n_T_in() { return N_IN; }

    /**
     * return the number of outlet temperatures
     */
    int get_n_T_out() { return N_OUT; }
    ...
    int get_inlet_connet_port(int idx = 0) { return _vec_ele_inlet_port[idx]; }
    ...
    double get_inlet_ratio(int idx = 0) { return _vec_inlet_ratio(idx); }

    double get_outlet_ratio(int idx = 0) { return _vec_outlet_ratio(idx); }

    void set_penalty_factor(double val) { _penalty_factor = val; }
