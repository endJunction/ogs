		...
		namespace BHE
		{
			BHE::BHE_2U *
				CreateBHE2U(BaseLib::ConfigTree const& config,
                    ...
                    std::unique_ptr<MaterialLib::Fluid::FluidProperty> const& bhe_refrigerant_density,
                    std::unique_ptr<MaterialLib::Fluid::FluidProperty> const& bhe_refrigerant_viscosity,
                    std::unique_ptr<MaterialLib::Fluid::FluidProperty> const& bhe_refrigerant_heat_capacity,
                    std::unique_ptr<MaterialLib::Fluid::FluidProperty> const& bhe_regrigerant_heat_conductivity) 
			{
				...
				BHE::BHE_2U * m_bhe_2u = new BHE::BHE_2U(
					...
					{ bhe_pipe_inner_radius, bhe_pipe_outer_radius,
                      ...
                      0.38, 0.38 /*lambda_p_i and lambda_p_o will not be used for 1U BHE*/}, /* Pipe Parameters */
