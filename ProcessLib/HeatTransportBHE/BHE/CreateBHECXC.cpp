	...
	namespace HeatTransportBHE
	{
		namespace BHE
		{
					...
					std::unique_ptr < MathLib::PiecewiseLinearInterpolation >> const& curves)
			{
				...
				const double bhe_inner_pipe_wall_thermal_conductivity = bhe_conf.getConfigParameter<double>("bhe_inner_pipe_wall_thermal_conductivity");
				const double bhe_outer_pipe_wall_thermal_conductivity = bhe_conf.getConfigParameter<double>("bhe_outer_pipe_wall_thermal_conductivity");
				...
				BHE::BHE_CXC * m_bhe_CXC = m_bhe_CXC = new BHE::BHE_CXC(
					bhe_ply_name,
					bhe_bound_type,
					curves,
					...
					{ bhe_pipe_inner_radius, bhe_pipe_outer_radius,
                      ...
                      bhe_inner_pipe_wall_thermal_conductivity, /* For CXC type BHE, used inner pipe lambda for wall lambda */
