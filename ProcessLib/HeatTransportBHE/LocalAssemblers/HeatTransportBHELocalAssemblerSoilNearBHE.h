...
#include "IntegrationPointDataSoilNearBHE.h"
...
private:
    ...
    std::vector<IntegrationPointDataSoilNearBHE<ShapeMatricesType,
                                                BMatricesType, GlobalDim>,
                Eigen::aligned_allocator<IntegrationPointDataSoilNearBHE<
