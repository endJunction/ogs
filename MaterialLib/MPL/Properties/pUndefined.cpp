...
PropertyDataType Undefined::value() const
{
    ...
    OGS_FATAL("The property \'%s\' (property-enum no. %i in MaterialLib/"
            "MPL/mpEnums.h) was requested, but is not defined in the "
            "project file.", property.c_str(), (int)thisPropertyEnum);
}
