...
m.setBehaviour('generic','src/libBehaviour.so',
...
m.setMaterialProperty('Cohesion',3.e19)
...
for i in range(npas-1):
    ...
    print(str(s.e1[0])+" "+str(s.e1[1])+" "+str(s.e1[2])+" "+str(s.e1[3])+" "+str(s.e1[4])+" "+str(s.e1[5])+" "+
        str(s.s1[0])+" "+str(s.s1[1])+" "+str(s.s1[2])+" "+str(s.s1[3])+" "+str(s.s1[4])+" "+str(s.s1[5]))
